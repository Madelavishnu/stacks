# housing dataset price prediction using LinearRegression
...
df = pd.read_csv('/Housing.csv')  #upload housing price dataset
df
#encode the data
le = LabelEncoder()
...
df
#check is there and null values are there
print(df.isnull().sum())
